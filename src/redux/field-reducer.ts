...
const initialState = {
    field: [
        ...
        [
            {isLightened: false, cellFigura: {figura: "rook", color: "black"}, cellColor: "white", cellAddress: "a1" },
            {isLightened: false, cellFigura: {figura: "knight", color: "black"}, cellColor: "black", cellAddress: "b1" },
            {isLightened: false, cellFigura: {figura: "bishop", color: "black"}, cellColor: "white", cellAddress: "c1" },
            ...
            {isLightened: false, cellFigura: {figura: "bishop", color: "black"}, cellColor: "black", cellAddress: "f1" },
            {isLightened: false, cellFigura: {figura: "knight", color: "black"}, cellColor: "white", cellAddress: "g1" },
            {isLightened: false, cellFigura: {figura: "rook", color: "black"}, cellColor: "black", cellAddress: "h1" },
        ] as RowType,
